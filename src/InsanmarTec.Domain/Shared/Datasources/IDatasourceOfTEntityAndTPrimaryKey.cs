...
{
    /// <summary>
    /// This interface is implemented by all datasources to ensure implementation of fixed methods.
    /// </summary>
    /// <typeparam name="TEntity">Main Entity type this datasource works on</typeparam>
    /// <typeparam name="TPrimaryKey">Primary key type of the entity</typeparam>
    public interface IDatasource<TEntity, TPrimaryKey> : IDatasource where TEntity : class, IEntity<TPrimaryKey>
    {
        ...
        /// <summary>
        /// Gets count of all entities in this datasource.
        /// </summary>
        ...
        /// <summary>
        /// Gets count of all entities in this datasource based on given <paramref name="predicate"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets count of all entities in this datasource (use if expected return value is greater than <see cref="int.MaxValue"/>.
        /// </summary>
        /// <returns>Count of entities</returns>
        long LongCount();
